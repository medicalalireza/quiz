        ...
        <div className="question">
          <div>
            <label htmlFor="question_five" className="question-title">
              ...
              مقطع کفش آقای کت شلوار نسبت به معکوس خودش بر نصف مقدار حاصله در
              مجموع با یک پای قطع شده ایشان چقدر میباشد؟ (از مقادیر تقریبی کوچک
              چشم پوشی شود)
            </label>
          ...
          <div>
            ...
            <label htmlFor="question_five" className="form-label">
              <span>
                به علت قانون وحدت شتاب، برابر با ثابت زمین و سطح مقطع 218cm
                <sup>2</sup> است
              </span>
            </label>
          </div>
          <div>
            ...
            <label htmlFor="question_five" className="form-label">
              <span>
                به علت قانون وحدت شتاب، برابر با ثابت زمین و سطح مقطع 436cm
                <sup>2</sup> است
              </span>
            </label>
          </div>
